        ...
        <>
          ...
          <div className={styles.drawer} role="dialog" aria-modal="true" aria-label="Site details">
            ...
            <div className={styles.drawerBody}>
              ...
              {(() => {
                const issues = HEALTH_FIELDS.filter(f => f.test(detailRow));
                if (!issues.length) return null;
                return (
                  <div className={styles.drawerSection}>
                    <div className={styles.drawerSectionTitle}>Data Health</div>
                    <div className={styles.drawerHealthList}>
                      {issues.map(f => (
                        <div key={f.key} className={styles.drawerHealthItem}>
                          <AlertSmIcon /> {f.label}
                        </div>
                      ))}
                    </div>
